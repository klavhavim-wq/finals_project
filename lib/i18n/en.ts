...
export const en: Dict = {
  ...
  tutorialVideos: "🎬 Tutorial Videos",     inst: [
       ...
       },
       {
         ...
         x: '<div style="display:flex;flex-direction:column;align-items:center;margin:0 0 8px"><svg width="140" height="130" viewBox="-5 0 250 245" xmlns="http://www.w3.org/2000/svg"><polygon points="120,20 207,70 207,170 120,220 33,170 33,70" fill="#FFF8E7" stroke="#C9A882" stroke-width="2"/><line x1="120" y1="20" x2="207" y2="70" stroke="#3B82F6" stroke-width="14" stroke-linecap="round"/><line x1="207" y1="70" x2="207" y2="170" stroke="#8B5CF6" stroke-width="14" stroke-linecap="round"/><line x1="207" y1="170" x2="120" y2="220" stroke="#F59E0B" stroke-width="14" stroke-linecap="round"/><line x1="120" y1="220" x2="33" y2="170" stroke="#EF4444" stroke-width="14" stroke-linecap="round"/><line x1="33" y1="170" x2="33" y2="70" stroke="#111827" stroke-width="14" stroke-linecap="round"/><line x1="33" y1="70" x2="120" y2="20" stroke="#3B82F6" stroke-width="14" stroke-linecap="round"/><text x="120" y="120" text-anchor="middle" dominant-baseline="middle" font-size="36" font-weight="700" fill="#78350F" font-family="Arial,sans-serif">42</text></svg></div><div style="margin:8px 0 10px;border-radius:12px;overflow:hidden;border:2px solid #e2e8f0;max-width:220px;margin-left:auto;margin-right:auto"><img src="/crop-plan-en.png" alt="Route planning panel" style="width:100%;display:block"/></div>Click hexes to build your route to the target.<br>Don\'t forget to mark the target hex too!<br><br>The door colors show the exercise difficulty and how many pellets each step earns.<br><br>💡 <strong>Direction guide:</strong> While building, the next valid hexes are highlighted with a green border on the board.<br><br><em style="font-size:.85em;color:#64748b">The colors in this picture are just an example — which doors you actually get depends on the level.</em>',
       },
       {
         i: "🚪",
         t: "Doors & Pellets",
         x: '<div style="display:flex;flex-direction:column;gap:7px;margin:0 0 10px;font-size:.85em"><div style="padding:7px 11px;background:#EFF6FF;border-radius:8px;border-left:4px solid #3B82F6"><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><strong style="color:#3B82F6">🦴 Blue — Bone</strong><span style="flex-shrink:0;background:#3B82F6;color:#fff;border-radius:999px;padding:2px 9px;font-weight:700;white-space:nowrap">1 pellet / step</span></div><div style="margin-top:4px;color:#475569">Tables up to 4 · e.g. <span dir="ltr" style="white-space:nowrap;font-weight:600;color:#1e293b">3 × 4 = 12</span></div></div><div style="padding:7px 11px;background:#F5F3FF;border-radius:8px;border-left:4px solid #8B5CF6"><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><strong style="color:#8B5CF6">🐟 Purple — Fish</strong><span style="flex-shrink:0;background:#7C3AED;color:#fff;border-radius:999px;padding:2px 9px;font-weight:700;white-space:nowrap">2 pellets / step</span></div><div style="margin-top:4px;color:#475569">Tables up to 6 · e.g. <span dir="ltr" style="white-space:nowrap;font-weight:600;color:#1e293b">4 × 5 = 20</span></div></div><div style="padding:7px 11px;background:#FFFBEB;border-radius:8px;border-left:4px solid #F59E0B"><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><strong style="color:#B45309">🍗 Orange — Wing</strong><span style="flex-shrink:0;background:#B45309;color:#fff;border-radius:999px;padding:2px 9px;font-weight:700;white-space:nowrap">5 pellets / step</span></div><div style="margin-top:4px;color:#475569">Tables up to 8 · e.g. <span dir="ltr" style="white-space:nowrap;font-weight:600;color:#1e293b">6 × 7 = 42</span></div></div><div style="padding:7px 11px;background:#FEF2F2;border-radius:8px;border-left:4px solid #EF4444"><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><strong style="color:#EF4444">🌭 Red — Sausage</strong><span style="flex-shrink:0;background:#EF4444;color:#fff;border-radius:999px;padding:2px 9px;font-weight:700;white-space:nowrap">10 pellets / step</span></div><div style="margin-top:4px;color:#475569">Tables 7–9 · e.g. <span dir="ltr" style="white-space:nowrap;font-weight:600;color:#1e293b">8 × 9 = 72</span></div></div><div style="padding:7px 11px;background:#F3F4F6;border-radius:8px;border-left:4px solid #111827"><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><strong style="color:#111827">🥩 Black — Steak</strong><span style="flex-shrink:0;background:#111827;color:#fff;border-radius:999px;padding:2px 9px;font-weight:700;white-space:nowrap">12 pellets / step</span></div><div style="margin-top:4px;color:#475569">Long multiplication · e.g. <span dir="ltr" style="white-space:nowrap;font-weight:600;color:#1e293b">13 × 4 = 52</span></div></div></div><em style="font-size:.8em;color:#7C3AED">Steak — Hero level only!</em><br><br>Harder = more pellets in the bank! 🐶<div style="margin:12px 0 4px;border-radius:12px;overflow:hidden;border:2px solid #e2e8f0;max-width:220px;margin-left:auto;margin-right:auto"><img src="/crop-panel-en.png" alt="Doors &amp; Points" style="width:100%;display:block"/></div><div style="font-size:.78em;color:#64748b;text-align:center">📸 As shown in the side panel</div>',
       },
       {
         i: "✅",
         t: "Review & Confirm",
