...
export const he: Dict = {
  ...
  tutorialVideos: "🎬 סרטוני הסבר",     inst: [
       ...
       },
       {
         i: "🚪",
         t: "דלתות וגרגירים",
         x: '<div style="display:flex;flex-direction:column;gap:7px;margin:0 0 10px;font-size:.85em"><div style="padding:7px 11px;background:#EFF6FF;border-radius:8px;border-right:4px solid #3B82F6"><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><strong style="color:#3B82F6">🦴 כחול — עצם</strong><span style="flex-shrink:0;background:#3B82F6;color:#fff;border-radius:999px;padding:2px 9px;font-weight:700;white-space:nowrap">1 גרגיר לצעד</span></div><div style="margin-top:4px;color:#475569">לוח הכפל עד 4 · למשל <span dir="ltr" style="white-space:nowrap;font-weight:600;color:#1e293b">3 × 4 = 12</span></div></div><div style="padding:7px 11px;background:#F5F3FF;border-radius:8px;border-right:4px solid #8B5CF6"><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><strong style="color:#8B5CF6">🐟 סגול — דג</strong><span style="flex-shrink:0;background:#7C3AED;color:#fff;border-radius:999px;padding:2px 9px;font-weight:700;white-space:nowrap">2 גרגירים לצעד</span></div><div style="margin-top:4px;color:#475569">לוח הכפל עד 6 · למשל <span dir="ltr" style="white-space:nowrap;font-weight:600;color:#1e293b">4 × 5 = 20</span></div></div><div style="padding:7px 11px;background:#FFFBEB;border-radius:8px;border-right:4px solid #F59E0B"><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><strong style="color:#B45309">🍗 כתום — כנף</strong><span style="flex-shrink:0;background:#B45309;color:#fff;border-radius:999px;padding:2px 9px;font-weight:700;white-space:nowrap">5 גרגירים לצעד</span></div><div style="margin-top:4px;color:#475569">לוח הכפל עד 8 · למשל <span dir="ltr" style="white-space:nowrap;font-weight:600;color:#1e293b">6 × 7 = 42</span></div></div><div style="padding:7px 11px;background:#FEF2F2;border-radius:8px;border-right:4px solid #EF4444"><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><strong style="color:#EF4444">🌭 אדום — נקניקיה</strong><span style="flex-shrink:0;background:#EF4444;color:#fff;border-radius:999px;padding:2px 9px;font-weight:700;white-space:nowrap">10 גרגירים לצעד</span></div><div style="margin-top:4px;color:#475569">לוח הכפל 7–9 · למשל <span dir="ltr" style="white-space:nowrap;font-weight:600;color:#1e293b">8 × 9 = 72</span></div></div><div style="padding:7px 11px;background:#F3F4F6;border-radius:8px;border-right:4px solid #111827"><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><strong style="color:#111827">🥩 שחור — סטייק</strong><span style="flex-shrink:0;background:#111827;color:#fff;border-radius:999px;padding:2px 9px;font-weight:700;white-space:nowrap">12 גרגירים לצעד</span></div><div style="margin-top:4px;color:#475569">כפל ארוך · למשל <span dir="ltr" style="white-space:nowrap;font-weight:600;color:#1e293b">13 × 4 = 52</span></div></div></div><em style="font-size:.8em;color:#7C3AED">סטייק — רמת גיבור בלבד!</em><br><br>קשה יותר = יותר גרגירים לבנק! 🐶<div style="margin:12px 0 4px;border-radius:12px;overflow:hidden;border:2px solid #e2e8f0;max-width:220px;margin-left:auto;margin-right:auto"><img src="/crop-panel-he.png" alt="דלתות ונקודות" style="width:100%;display:block"/></div><div style="font-size:.78em;color:#64748b;text-align:center">📸 ככה זה נראה בפאנל הצידי</div>',
       },
       {
         i: "✅",
       ...
       },
       {
         i: "🐕",
         t: "שלב 3 — יוצאים לדרך!",
         x: '<div style="margin:0 0 10px;border-radius:12px;overflow:hidden;border:2px solid #e2e8f0;max-width:200px;margin-left:auto;margin-right:auto"><img src="/crop-bar-he.png" alt="חלון המשחק" style="width:100%;display:block"/></div>הכלב קופץ ללוח ומתחיל לנוע! 🐾<br><br>לכל צעד:<br>1️⃣ לוחצים "זרוק" 🎲<br>2️⃣ מקבלים תרגיל כפל לפי צבע הדלת<br>3️⃣ עונים על ידי לחיצה על משושה, הקלדה, או כפתורי בחירה<br><br>✅ נכון ← הכלב מתקדם + גרגירים! 🦴<br>❌ טעות ← אפשר לנסות שוב בלי הגבלה!<br>💡 חושפים תשובה ← הכלב נעצר, <strong>הגרגירים שנצברו עד כה נשמרים!</strong> 🦴<br><br>🔢 <strong>צריכים עזרה?</strong> לחצו על כפתור "לוח כפל" בתחתית הפאנל בכל עת.<br><br>🙋 <strong>שחקנים אחרים יכולים לעזור!</strong> כשהשחקן הפעיל פותר — כל שחקן אחר לוחץ על שמו ומנסה לענות. מי שצודק מקבל +1 גרגיר! 🦴',
       },
       {
         i: "⏱",
         t: "הגבלת זמן",
  ...
  simpleGuide: (level) => {
    ...
    const LV: Record<string, string> = {
      beg: '🐾 <strong>מתחילים</strong> — לוח הכפל עד 40. הלוח קצר ונוח, עם מספרים עד 40. מושלם להתחלה! 😊',
      med: '⭐ <strong>בינוני</strong> — לוח הכפל עד 60. הלוח עם מספרים עד 60.',
      adv: '🌟 <strong>מתקדם</strong> — לוח הכפל עד 90. הלוח עם מספרים עד 90.',
      champ: '🏆 <strong>אלוף</strong> — לוח הכפל עד 100. הלוח עם מספרים עד 100.',
  ...
  difficulty: "📊 רמת קושי",
  levels: {
    beg: { icon: "🐾", name: "מתחילים", desc: "לוח הכפל עד 40" },
