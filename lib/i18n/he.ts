  ...
  tour: (level) => {
    ...
    const pages: TourStep[] = [
      ...
      },
      {
        ...
        stage: "find",
        interact: "find",
        x: "בואו ננסה באמת! פתרו את התרגיל למטה ולחצו על המשושה עם התשובה בלוח. 👆<br><br>לא בטוחים? אפשר פשוט ללחוץ «הבא» וממשיכים.",
      },
      {
        i: "🚪",
      ...
      },
      {
        ...
        stage: "walk",
        interact: "answer",
        x: "עכשיו פתרו את התרגיל של הדלת ובחרו את התשובה. 🦴<br><br>לא בטוחים? אפשר פשוט ללחוץ «הבא» וממשיכים.",
      },
      {
        i: "🙋",
        t: "עוזרים ומרוויחים",
