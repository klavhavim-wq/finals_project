...
export const he: Dict = {
  ...
  tourSolved: "✅ כל הכבוד! פתרת נכון 🎉",
  tourYourTurn: "👉 תורך — פתרו:",
  ...
  openFactsTitle: "🎯 מה עוד בתרגול",
  openFactsHint: "התרגילים שהמשחק ממשיך להחזיר לכל שחקן, מהצריך הכי הרבה תרגול ומטה. תרגיל נגרע מהרשימה כשעונים עליו נכון ומהר.",
  openFactsCount: (n) => (n === 1 ? "תרגיל אחד" : `${n} תרגילים`),
  openFactsWeight: (w) => `דורש עוד ${w} ${w === 1 ? "תשובה נכונה ומהירה" : "תשובות נכונות ומהירות"}`,
  viewResults: "📊 תוצאות",
  ...
  quickLaunchBtn: "⚡ הפעלה מהירה",
  qlTitle: "⚡ הפעלה מהירה",
  qlSub: "בוחרים רמה וכמה שחקנים, ולוחצים על סוג משחק כדי להתחיל לשחק מיד.",
  qlLevelLabel: "📊 רמה",
  qlPlayersLabel: "👥 שחקנים",
  ...
  presets: {
    focus: {
      icon: "🎯",
      name: "תרגול ממוקד",
      desc: "לוח רגוע, בלי שעון, ועדיין עם ניקוד — כל הקשב על החשבון.",
    },
    free: {
      icon: "🎓",
      name: "תרגול חופשי",
      desc: "בלי ניקוד, בלי מנצח, בלי לחץ — רק סופרים כמה תרגילים נפתרו.",
    },
    calm: {
      icon: "🤝",
      name: "רגוע ומשותף",
      desc: "משחק שיתופי, עדין ובלי הסחות — כולם קבוצה אחת.",
    },
    full: {
      icon: "🎮",
      name: "משחק מלא",
      desc: "החוויה השלמה — שעון, גניבות, הפתעות והכול.",
    },
  },

  phaseLabels: ["מצא יעד", "תכנן", "צא לדרך"],

  playTogether: "👫 משחק משותף",
  lobbyTitle: "👫 משחק משותף",
  lobbyIntro:
    "משחקים על אותו לוח, כל אחד מהמסך שלו. מישהו אחד פותח את המשחק ומקריא את הקוד, וכל השאר מקלידים אותו.",
  lobbyCreateBtn: "🎲 פתיחת משחק",
  lobbyJoinBtn: "🔑 הצטרפות למשחק",
  lobbyBackBtn: "← חזרה",
  lobbyYourNameLabel: "השם שלך",
  lobbyCodeEnterLabel: "הקלידו את הקוד שקיבלתם",
  lobbyJoinGoBtn: "הצטרפות",
  lobbyCreateGoBtn: "פתיחת המשחק",
  lobbyWaitTitle: "מחכים להתחלה",
  ...
  lobbyErrors: {
    ...
    full: "המשחק מלא — כבר יש בו ארבעה שחקנים.",
    ...
    busy: "כולם לחצו באותו רגע — נסו שוב.",
